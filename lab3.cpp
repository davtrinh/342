...
int main() {
	...
	List<NodeData> mylist, mylist2, mylist3, mylist4, mylist5, mylist6;
	...
	mylist.intersect(mylist2, mylist);
	...
	List<Employee> company1, company2, company3, company4, company5, company6,
		company7, company8, company9, company10, company11, company12, company13;
	...
	company1.intersect(company9, company9);
	...
	cout << "--------------------COMPANY 6--------------------" << endl;
	cout << "Company6:" << endl << company6 << endl;
	company6.merge(company6, company6);
	cout << "Company6 with 6 6:" << endl << company6 << endl;
	company6.merge(company12, company6);
	cout << "Company6 with 12 6:" << endl << company6 << endl;
	
	
	company6.merge(company7, company7);
	cout << "Company6 with 7 6:" << endl << company6 << endl;
	
	//company1.merge(company12, company12);

	cout << "Company 1 Before = : " << company2 << endl;
*/
	//company2 = company2;
	//company1 = company2;
	cout << "-----------------INTERSECT---------------" << endl;
	
	cout << "Company 1 Intersecting with self: \n" << company1 << endl;
	cout << "Company 2\n " << company2 << endl;
	company1.intersect(company2, company1);
	cout << "Company 1 After \n" << company1 << endl;
	


	cout << "Company 1 Intersecting with null: \n" << company1 << endl;
	cout << "Company null \n" << company2 << endl;
	company1.intersect(company1, company1);
	cout << "Company 1 After \n" << company2 << endl;




	//cout << "Company 1 After = : " << company2 << endl;
	/*
